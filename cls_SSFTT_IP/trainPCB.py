...
def loadData():
    # 读入数据
    data = sio.loadmat('../data/Indian_pines_corrected.mat')['pcb']
    labels = sio.loadmat('../data/Indian_pines_gt.mat')['pcb_gt']
...
def acc_reports(y_test, y_pred_test):
    ...
    target_names = ['IC', 'Capacitor', 'Connector',]
...
if __name__ == '__main__':
    ...
    dataset_path = "/content/drive/MyDrive/pcb_vision/PCBDataset/"
