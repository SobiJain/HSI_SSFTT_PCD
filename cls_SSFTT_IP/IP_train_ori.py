...
def train(train_loader, epochs):
    ...
    summary(net, input_size=(BATCH_SIZE_TRAIN, 1, pca_components, patch_size,patch_size),col_names=['num_params','kernel_size','mult_adds','input_size','output_size'],col_width=10,row_settings=['var_names'],depth=4)
...
if __name__ == '__main__':
    ...
    Test_time = toc2 - tic2
    file_name = "cls_result/classification_report"+str(dataset)+" "+str((1-test_ratio)/2)+".txt"
